import { ActivityIndicator, Animated, Dimensions, Image, Modal, ScrollView, StyleSheet, Text, TextInput, ToastAndroid, TouchableOpacity, View, Platform } from 'react-native'
        ...
        if (suggestedData && data) {
            ...
            await firestore()
                ...
                .then(() => {
                    ...
                    Toast.show(`Suggestion send to ${data.Name}`, Toast.SHORT);
                    setUploading(false)
                    setModal(false)
                    // navigation.goBack()
                });
            ...
            console.log('no');
            Toast.show("Network error try again later!", Toast.SHORT);
        }
    }
