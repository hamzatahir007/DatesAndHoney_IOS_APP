...
const EditUserCredentials = ({ title, image, data, filter, setModal, Modal }) => {
        ...
        if (data !== value2) {
            ...
            try {
                ...
                userRef.update({
                    ...
                    setUploading(false)
                    setModal(false)
                    Toast.show(`Your new name updated!`, Toast.SHORT)
                })
            }
            catch (e) {
                setUploading(false)
            ...
            Toast.show(`Please update your name to save changes.`, Toast.SHORT)
        }
    }
        ...
        if (data !== value2) {
            ...
            try {
                ...
                userRef.update({
                    ...
                    setUploading(false)
                    setModal(false)
                    Toast.show(`Your new email updated!`, Toast.SHORT)
                })
            }
            catch (e) {
                setUploading(false)
            ...
            Toast.show(`You have not changed your email.`, Toast.SHORT)
    ...
    const updatePhoneNumber = async (number) => {
        ...
        try {
            ...
            setUploading(false)
            Toast.show(`Error updating phone number and details: , ${error.message}`, Toast.SHORT)
        ...
        if (code && otpResult) {
            try {
                ...
                try {
                    ...
                    setUploading(false)
                    setModal(false)
                    Toast.show(`Currently you cannot update phone number!`, Toast.SHORT)
                ...
                //     Toast.show(`Phone number updated successfully!`, Toast.SHORT)
                // });
            } catch (error) {
                setUploading(false)
                setModal(false)
            ...
            setUploading(false)
            setModal(false)
            Toast.show(`Verification code cannot be empty`, Toast.SHORT)
        }
    }
    return (
        <View style={{
