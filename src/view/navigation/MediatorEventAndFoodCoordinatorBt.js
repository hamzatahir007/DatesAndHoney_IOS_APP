...
const HomeStack = ({ navigation }) => (
    <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name='MediatorDashboardScreen' component={MediatorDashboardScreen} options={{
            unmountOnBlur: true
        }}/>
        <Tab.Screen name='MediatorEditEventScreen' component={MediatorEditEventScreen} options={{
            unmountOnBlur: true
        }}/>
        <Tab.Screen name='MediatorEditFoodScreen' component={MediatorEditFoodScreen} options={{
            unmountOnBlur: true
        }}/>
    </Tab.Navigator>
)
const MediatorCreateStack = ({ navigation }) => (
    <Tab.Navigator screenOptions={{
        ...
        tabBarStyle: {
            ...
            <Tab.Screen name="MediatorCreateServices" component={MediatorCreateServices} options={{
            unmountOnBlur: true
        }}/>
            <Tab.Screen name="MediatorCreateEventScreen" component={MediatorCreateEventScreen} options={{
            unmountOnBlur: true
        }}/>
            <Tab.Screen name="MediatorCreateFoodScreen" component={MediatorCreateFoodScreen} options={{
            unmountOnBlur: true
        }}/>
    </Tab.Navigator>
)
