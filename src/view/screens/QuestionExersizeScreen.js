...
const QuestionExersizeScreen = ({ navigation, route }) => {
  ...
  const onExersizePartnerScreen = () => {
    ...
    if (selectedCategoryIndex !== null && checked) {
      ...
      navigation.navigate('QuestionCuddlingScreen', update)
    }
    else {
      if (selectedCategoryIndex == null) {
        Toast.show("Please select your excersize duration!", Toast.SHORT);
      }
      else if (checked == null) {
        Toast.show("Please select your excersize type!", Toast.SHORT);
      }
    }
  }
      ...
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{
            ...
            />
            <Text style={{color:COLORS.black, fontSize:12}}>Public</Text>
            <RadioButton
              value="Not Public"
              ...
              uncheckedColor={COLORS.main}
            />
            <Text style={{color:COLORS.black, fontSize:12}}>Not Public</Text>
