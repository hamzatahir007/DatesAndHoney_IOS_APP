...
const SelectionThreeQuestionIntroandExtroScreen = ({ navigation, route }) => {
  ...
  const onPIntroandExtro = () => {
    if (selectedCategoryIndex !== null) {
      ...
      Toast.show("Please select your nature!", Toast.SHORT);
    }
  }
...
export default SelectionThreeQuestionIntroandExtroScreen
