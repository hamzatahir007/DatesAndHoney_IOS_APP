...
const SelectionThreeQuestionHairColorScreen = ({ navigation, route }) => {
  ...
  const onQuestionEyeColorScreen = () => {
    ...
    if (selectedCategoryIndex?.length > 0) {
      ...
      // console.log(update);
      // return
      navigation.navigate('SelectionThreeQuestionEyeColorScreen', update)
    }
    else {
...
export default SelectionThreeQuestionHairColorScreen
