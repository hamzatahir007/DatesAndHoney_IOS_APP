import { Image, SafeAreaView, StatusBar, StyleSheet, Text, View, TextInput, TouchableOpacity, ScrollView, Dimensions } from 'react-native'
...
const SelectionThreeQuestionMovieTypeScreen = ({ navigation, route }) => {
  ...
  const onInBedScreen = () => {
    if (selectedCategoryIndex?.length > 0) {
      ...
      Toast.show("Please select movie type!", Toast.SHORT);
    }
  }
