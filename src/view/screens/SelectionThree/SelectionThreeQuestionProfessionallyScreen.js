...
const SelectionThreeQuestionProfessionallyScreen = ({ navigation, route }) => {
  ...
  const onMusicSelect = () => {
    if (experince && experince2) {
      ...
      navigation.navigate('SelectionThreeQuestionLongestRelationshipScreen', data)
      ...
      if (!experince) {
        Toast.show("Please enter you see your self in five years", Toast.SHORT);
      }
      else if (!experince2) {
        Toast.show("Please enter you see your self in ten years", Toast.SHORT);
      }
      else {
        Toast.show("Please enter both experinces!", Toast.SHORT);
      }
    }
  }
