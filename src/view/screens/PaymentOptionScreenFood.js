import { TextInput, TouchableOpacity, SafeAreaView, Platform,Image, StatusBar, StyleSheet, Text, View, ScrollView, ToastAndroid, Dimensions, ImageBackground } from 'react-native'
...
import { PaymentCardDetails, PaymentMethod, selectPaymentCards } from '../../../redux/reducers/Reducers';
...
const PaymentOptionScreenFood = ({ navigation, route }) => {
    ...
    const AddYourCard = () => {
        if (selectedCategoryIndex !== null) {
            ...
            navigation.navigate('AddCardScreenFood', { data: PaymentType[selectedCategoryIndex] });
            // navigation.navigate('AddCardScreen')
        }
        else {
            Toast.show("Please select payment type!", Toast.SHORT);
        }
    }
                                            ...
                                            <TouchableOpacity
                                                ...
                                                <View style={{
                                                    ...
                                                    <View style={{
                                                        ...
                                                        <View>
                                                            <Text style={{ fontSize: 12 }}>{'************' + j?.cardNumber}</Text>
                                                        </View>
                                                        <View>
                                                            <Text style={{ fontSize: 12 }}>{j?.ExpMonth} / {j?.ExpYear}</Text>
                                                        </View>
                                                    </View>
                                                </View>
                                            </TouchableOpacity>
...
export default PaymentOptionScreenFood
