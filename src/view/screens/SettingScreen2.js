import { Image, StatusBar, StyleSheet, Platform,Text, View, SafeAreaView, TouchableOpacity, TextInput, ScrollView, ToastAndroid, Dimensions, Modal } from 'react-native'
...
const SettingScreen = ({ navigation }) => {
    ...
    const OnSaveChanges = () => {
        ...
        if (!name ||
            ...
            !languages) {
            if (!name) {
                Toast.show('Please enter your new name!', Toast.SHORT)
                setUploading(false)
            }
            else if (!email) {
                Toast.show('Please enter your new email!', Toast.SHORT)
                setUploading(false)
            }
            else if (!number) {
                Toast.show('Please enter your new number!', Toast.SHORT)
                setUploading(false)
            }
            else if (!bio) {
