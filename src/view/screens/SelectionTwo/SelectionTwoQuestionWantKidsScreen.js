...
const SelectionTwoQuestionWantKidsScreen = ({ navigation, route }) => {
  // console.log(email);
  ...
  const onBioPress = () => {
    ...
    if (selectedCategoryIndex !== null) {
      ...
      Toast.show("Please select kids types!", Toast.SHORT);
    }
  }
...
export default SelectionTwoQuestionWantKidsScreen
