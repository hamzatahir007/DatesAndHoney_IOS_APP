...
const SelectionTwoQuestionFavFoodScreen = ({ navigation, route }) => {
  ...
  const onExersizeScreen = () => {
    ...
    if (!selectedItems.length == 0) {
      ...
      navigation.navigate('SelectionTwoQuestionExersizeScreen', update)
    }
    else {
      Toast.show("Please select your Food!", Toast.SHORT);
    }
  }
...
export default SelectionTwoQuestionFavFoodScreen
