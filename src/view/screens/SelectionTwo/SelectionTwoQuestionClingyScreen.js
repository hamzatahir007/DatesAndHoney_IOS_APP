import { Image, SafeAreaView, StatusBar, StyleSheet, Text, View, TextInput, TouchableOpacity, ScrollView, ActivityIndicator, Modal, Dimensions } from 'react-native'
...
const SelectionTwoQuestionClingyScreen = ({ navigation, route }) => {
  ...
  const onCongratsScreen = async () => {
    if (clingy) {
      ...
      Toast.show("Please select Clingy Type!", Toast.SHORT);
    }
  }
