...
const SelectionTwoQuestionHeightScreen = ({ navigation, route }) => {
  ...
  const onQuestionHeightPartnerScreen = () => {
    if (yourHeight && yourHeight >= 2) {
      ...
      // // console.log(data2);
      // return
      navigation.navigate('SelectionTwoQuestionBuildTypeScreen', update)
    }
    else {
      if (!yourHeight) {
        ...
        Toast.show("Selected height must be grater 2ft!", Toast.SHORT);
      }
    }
  }
...
export default SelectionTwoQuestionHeightScreen
