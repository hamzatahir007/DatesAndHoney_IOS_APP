  ...
  const onContinue = () => {
    if (!location, !trackingTime, !region, !arrivalTime) {
      if (!location) {
        ...
        Toast.show("Please select tracking Time first!", Toast.SHORT);
      }
      else if (!region) {
        Toast.show("Please select region first!", Toast.SHORT);
      }
      else if (!arrivalTime) {
        Toast.show("Please select arrival Time first!", Toast.SHORT);
      }
    }
    else {
  ...
  return (
    <SafeAreaView style={{
      ...
      <View style={styles.container}>
        ...
        <SimpleHeader center='Date Mode' onpress={() => navigation.goBack()} />
                  ...
                  <View style={{ marginTop: 0 }}>
                    ...
                    <View style={{
                      ...
                      >
                        ...
                        {user.Location != undefined && region != undefined ? (
                          <MapViewDirections
