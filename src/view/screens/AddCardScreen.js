import { TouchableOpacity, SafeAreaView, Platform, Modal, Image, StatusBar, StyleSheet, Text, View, ScrollView, ToastAndroid, Dimensions, Alert, ActivityIndicator } from 'react-native'
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            fontSize: 16,
                            textAlign: 'center',
                        }}>Payment Card Successfully Added</Text>
                        <Text style={{
                            marginBottom: 10,
                            textAlign: 'center',
                            fontSize: 12,
                            ...
                            Congratulations! You've successfully added your payment card to our secure platform.
                        </Text>
                        <Image source={require('../../assets/flakeremove.png')} resizeMode='cover' />
                        <TouchableOpacity
