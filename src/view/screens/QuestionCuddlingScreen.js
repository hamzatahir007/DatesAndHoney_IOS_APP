...
const QuestionCuddlingScreen = ({ navigation, route }) => {
  ...
  const onClingyScreen = () => {
    if (selectedCategoryIndex !== null) {
      ...
      navigation.navigate('QuestionClingyScreen', update)
    }
    else {
      Toast.show("Please select your cuddling!", Toast.SHORT);
    }
  }

  const onSkip = async () => {
    Toast.show('Cudiling skipping...', Toast.SHORT)
