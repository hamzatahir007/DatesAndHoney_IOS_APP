...
const CheckoutScreenEvent = ({ navigation, route }) => {
    ...
    const updatePromoterWallet = async (data) => {
        if (promoterId && data?.promoterReward) {
            const promoterReward = parseFloat((data?.totalPrice * data?.promoterReward) / 100).toFixed(2);
                                    ...
                                    if (documentSnapshot.exists) {
                                        ...
                                        docRef.update({
                                            TicketsHistory: firestore.FieldValue.arrayUnion({
                                                TicketAddToCard: {
                                                    ...TicketAddToCard,
                                                    promoterId: TicketAddToCard?.promoterId?.PromoterId || null
                                                },
                                                createdAt: time,
                                                useruid: user?.uid,
                                                status: false
            ...
            try {
                ...
                if (querySnapshot?.empty) {
                    ...
                    if (!TicketAddToCard.appliedPromo && TicketAddToCard?.discountedReferral) {
                        ...
                        const appliedPromo = parseFloat((TransactionAmount * TicketAddToCard?.discountedReferral) / 100).toFixed(2);
                        let sum = (TicketAddToCard?.totalPricewithTaxes - appliedPromo).toFixed(2);
                        // const promoterReward = parseFloat((data?.Tickets?.pricePerTicket * data?.promoterReward) / 100).toFixed(2);
                        // console.log('===:', appliedPromo, sum)
                        // return
                                ...
                                <View>
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={{ fontSize: 12, color: COLORS.gray, marginRight: 5 }}>Ticket Price({TicketAddToCard?.Tickets?.qty})</Text>
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={{ fontSize: 12, color: COLORS.gray, marginRight: 5 }}>Service Fee</Text>
                                    ...
                                    {TicketAddToCard?.appliedPromo &&
                                        <View style={{
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{ fontSize: 12, color: COLORS.gray }}>{TicketAddToCard?.appliedPromoPercent ? TicketAddToCard?.appliedPromoPercent : TicketAddToCard?.discountedReferral}%</Text>
                                                {/* <SVGNotify width={15} height={15} onPress={() => { setTaxes(true), setTaxesType('DAHFee') }} /> */}
                                            </View>
