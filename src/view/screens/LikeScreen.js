    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <View style={styles.container}>
        ...
        <HeaderTabOne onpress={() => navigation.openDrawer()} Lefticon={require('../../assets/menu.png')}
          logo={require('../../assets/logo2.png')} Righticon={'Matches'} RighticonTextColor={'#2A3182'} onpress2={() => navigation.navigate('Message')} />
        ...
        <View style={{
          ...
          <View style={{ paddingVertical: 5 }}>
            <CustomeButton title={'Premium Options'} width={width / 1.1} image={require('../../assets/Crown.png')}
              border={COLORS.main} onpress={() => navigation.navigate('Premium Membership')} />
          </View>
