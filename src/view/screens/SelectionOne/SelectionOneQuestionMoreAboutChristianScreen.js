...
const SelectionOneQuestionMoreAboutChristianScreen = ({ navigation, route }) => {
  ...
  const onDietScreen = () => {
    ...
    if (selectedReligionIndex!==null && selectedParentIndex!==null) {
...
export default SelectionOneQuestionMoreAboutChristianScreen
