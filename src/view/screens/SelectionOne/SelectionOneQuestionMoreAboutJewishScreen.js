...
const SelectionOneQuestionMoreAboutJewishScreen = ({ navigation, route }) => {
  ...
  const [selectedkosherIndex, setSelectedKosherIndex] = useState(null);
  ...
  const onDietScreen = () => {
    ...
    if (selectedParentIndex!==null && selectedReligionIndex!==null && selectedkosherIndex!==null) {
      ...
      Toast.show("Please select your Religion Details!", Toast.SHORT);
    }
  }
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity activeOpacity={0.8} onPress={onJewaish2}>
            ...
            <TouchableOpacity onPress={toggleDropdown2} style={{
              alignSelf: 'center',
            }}>
              <View style={styles.NumberInput}>
...
export default SelectionOneQuestionMoreAboutJewishScreen
