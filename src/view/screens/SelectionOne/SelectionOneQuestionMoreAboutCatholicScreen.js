...
const SelectionOneQuestionMoreAboutCatholicScreen = ({ navigation, route }) => {
  ...
  const onDietScreen = () => {
    ...
    if (selectedParentIndex !== null && selectedReligionIndex !== null) {
      ...
      Toast.show("Please select your Religion Detials!", Toast.SHORT);
    }
  }
...
export default SelectionOneQuestionMoreAboutCatholicScreen
