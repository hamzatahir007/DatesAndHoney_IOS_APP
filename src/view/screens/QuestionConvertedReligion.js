...
const QuestionConvertedReligion = ({ navigation, route }) => {
  ...
  // console.log(ServayCategory);



  const onConvertedReligion = () => {
    if (!ServayCategory) {
      Toast.show("Please select converted religion!", Toast.SHORT);
    }
    else {
      if (ServayCategory == 'Yes') {
        if (!LisrtPros) {
          Toast.show("Please explain converted religion!", Toast.SHORT);
        }
        else {
...
export default QuestionConvertedReligion
