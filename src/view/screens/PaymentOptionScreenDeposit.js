...
const PaymentOptionScreenDeposit = ({ navigation, route }) => {
...
// console.log(SelectedPaymentCards);
    const AddYourCard = () => {
        if (selectedCategoryIndex !== null) {
            ...
            navigation.navigate('AddCardScreenDeposit', { data: PaymentType[selectedCategoryIndex] });
...
export default PaymentOptionScreenDeposit
