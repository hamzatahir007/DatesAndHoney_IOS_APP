...
const QuestionMultipleSubstance = ({ navigation, route }) => {
  ...
  const SkipScreen = async () => {
    ...
    // else {
    //   if (!smokeData) {
    //     Toast.show("Please select do you smoke to skip!", Toast.SHORT);
    //   }
    //   else if (!vapeData) {
    //     Toast.show("Please select do you vape to skip!", Toast.SHORT);
    //   }
    //   else if (!marijuanaData) {
    //     Toast.show("Please select do you marijuana to skip!", Toast.SHORT);
    //   }
    //   else if (!drugsData) {
    //     Toast.show("Please select do you drugs to skip!", Toast.SHORT);
    //   }
    //   else if (!drinkData) {
    //     Toast.show("Please select do you drink!", Toast.SHORT);
    //   }
