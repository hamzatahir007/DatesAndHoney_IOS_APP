import { SafeAreaView,Platform, StatusBar, StyleSheet, Text, View, Image, useWindowDimensions, TouchableOpacity, ActivityIndicator, Dimensions, Modal, ToastAndroid, ScrollView, Pressable } from 'react-native';
...
const ChatingScreen = ({ navigation, route }) => {
    ...
    //             Toast.show('Coversation clear', Toast.SHORT)
    //             setUploading(false);
    //         } catch (e) {
    //             setUploading(false)
                ...
                try {
                    ...
                    if (mydocGet?.exists) {
                        ...
                        if (checkUser) {
                            ...
                            setLoading(false)
                            // return
                            Toast.show(`${userName} Already Blocked`, Toast.SHORT);
                            OnDeleteUser(Currentuser)
