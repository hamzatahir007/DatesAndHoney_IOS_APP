import { Dimensions, Image, Modal, Platform,SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
                            ...
                            {coordinatorReqStatus?.enable == 2 ?
                                ...
                                coordinatorReqStatus?.enable == 1 ?
                                    ...
                                    coordinatorReqStatus?.enable == 3 ?
                                        <CustomeButton
                                            onpress={() => loading ? null : SendRequest()}
                                            title={loading ? 'Please wait...' : `Request to work with ${data?.Name}`}
                                            width={width / 1.1}
                                        />
                                        :
                                        <CustomeButton
                                            onpress={() => loading ? null : SendRequest()}
                                            title={loading ? 'Please wait...' : `Request to work with Sofia ${data?.Name}`}
                                            width={width / 1.1}
                                        />
                            }
                        </View>
