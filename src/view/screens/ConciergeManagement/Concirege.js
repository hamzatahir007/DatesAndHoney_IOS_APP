import { Dimensions, Image, Modal, SafeAreaView, Platform,TextInput, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
        ...
        try {
            ...
            if (!ref?.empty) {
                ...
                ref.forEach(element => {
                    ...
                    let checkUserReligion = data?.FilterReligion === 'All' || (data?.FilterReligion && data?.FilterReligion == user?.Relagion);
                    // console.log(data?.MediatorId == 2 && data?.MediatorType == 'Match Coordinator' && data?.Category == 'Mediator' && data?.PanelAccess && !checkUser , '=========================');
