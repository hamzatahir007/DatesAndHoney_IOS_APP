import { Image, StatusBar, StyleSheet, Platform, Text, View, SafeAreaView, TouchableOpacity, TextInput, ScrollView, ToastAndroid, Dimensions, Modal, Alert } from 'react-native'
...
const SettingScreen = ({ navigation }) => {
    ...
    const OnSaveChanges = () => {
        ...
        if (!bio ||
            ...
            !languages) {
            if (!bio) {
                Toast.show('Please enter your bio!', Toast.SHORT)
                setUploading(false)
            }
            else if (!BuildType) {
                Toast.show('Please enter your Build Type!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Dates) {
                Toast.show('Please enter your Date of Birth!', Toast.SHORT)
                setUploading(false)
            }
            else if (!gender) {
                ...
                Toast.show('Please select your gender Type!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Hieght) {
                Toast.show('Please enter your height!', Toast.SHORT)
                setUploading(false)
            }
            else if (!educationObj) {
                Toast.show('Please select your education!', Toast.SHORT)
                setUploading(false)
            }
            else if (!educationObj) {
                Toast.show('Please select your education!', Toast.SHORT)
                ...
                Toast.show('Please enter your new Relagion!', Toast.SHORT)
                setUploading(false)
            }
            else if (!ParentReligion) {
                Toast.show('Please enter your new Parent Religion!', Toast.SHORT)
                setUploading(false)
            }
            else if (!religionType) {
                Toast.show('Please enter your religion Type!', Toast.SHORT)
                setUploading(false)
            }
            else if (!ConvertedReligion) {
                Toast.show('Please enter your converted Religion!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Lookingfor) {
                Toast.show('Please enter what are you looking for!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Lookingfor) {
                Toast.show('Please enter what are you looking for!', Toast.SHORT)
                ...
                Toast.show('Please enter your occupation!', Toast.SHORT)
                setUploading(false)
            }
            else if (!CoupleOption) {
                Toast.show('Please enter your Couple Option!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Cuddling) {
                Toast.show('Please enter your cuddling type!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Clingy) {
                Toast.show('Please enter your clingy type!', Toast.SHORT)
                setUploading(false)
            }
            else if (!DealBreaker) {
                Toast.show('Please select your Deal Breaker!', Toast.SHORT)
                setUploading(false)
            }
            else if (!DealMakers) {
                Toast.show('Please select your Deal Makers!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Diet) {
                Toast.show('Please select your diet type!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Drink) {
                Toast.show('Please select do you Drink!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Drugs) {
                Toast.show('Please select do you use Drugs!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Ethnicity) {
                Toast.show('Please select your ethnicity!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Exercise) {
                Toast.show('Please select your Exercise!', Toast.SHORT)
                setUploading(false)
            }
            else if (!EyeColor) {
                Toast.show('Please select your Eye Color!', Toast.SHORT)
                setUploading(false)
            }
            else if (!HairColor) {
                Toast.show('Please select your Hair Color!', Toast.SHORT)
                setUploading(false)
            }
            else if (!FavFood) {
                Toast.show('Please select your Fav Food!', Toast.SHORT)
                setUploading(false)
            }
            else if (!InFiveYear) {
                Toast.show('Please enter where do you see your self in five years!', Toast.SHORT)
                setUploading(false)
            }
            else if (!InTenYear) {
                Toast.show('Please enter where do you see your self in ten year!', Toast.SHORT)
                setUploading(false)
            }
            else if (!InstaUsername) {
                Toast.show('Please enter your instagram username!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Kids) {
                Toast.show('Please enter dop you want kids!', Toast.SHORT)
                setUploading(false)
            }
            else if (!LongestRelationship) {
                Toast.show('Please enter your longest relationship!', Toast.SHORT)
                setUploading(false)
            }
            else if (!MovieType) {
                Toast.show('Please enter what type of movies you like!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Nature) {
                Toast.show('Please enter are you introvert or extrovert!', Toast.SHORT)
                setUploading(false)
            }
            else if (!PoliticalView) {
                Toast.show('Please enter your political view!', Toast.SHORT)
                setUploading(false)
            }
            else if (!PoliticalViewStatus) {
                Toast.show('Please select your political view stats!', Toast.SHORT)
                setUploading(false)
            }
            else if (!RelationshipType) {
                Toast.show('Please enter your relationship type you are looking for!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Smoke) {
                Toast.show('Please enter do you Smoke!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Vape) {
                Toast.show('Please enter do you Vape!', Toast.SHORT)
                setUploading(false)
            }
            else if (!Marijauna) {
                Toast.show('Please enter do you Marijauna!', Toast.SHORT)
                setUploading(false)
            }
            else if (!languages) {
                Toast.show('Please select your languages you speak!', Toast.SHORT)
                setUploading(false)
            }
            setUploading(false)
        }
            ...
            userRef.update({
                ...
                Toast.show('Your Profile hase been updated!', Toast.SHORT)
            })
            // console.log('here');
            //             
            // email
        ...
        try {
            auth()
                ...
                .then(() =>
                    ...
                    Toast.show('Signed out!', Toast.SHORT)
    ...
    const deleteAccount = async () => {
        ...
        try {
            ...
            await auth()
                .signOut()
                setUploading(false),
                Toast.show('User account deleted successfully', Toast.SHORT),
                RNRestart.Restart()
            ...
            Toast.show(`Error : ${exception}`, Toast.SHORT),
                // return false;
                setUploading(false)
        }
    }
                ...
                <ScrollView vertical showsVerticalScrollIndicator={false}>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <View style={{ marginTop: 10 }}>
                                <TouchableOpacity
                                    ...
                                    <Text style={{ color: COLORS.white, textAlign: 'center' }}>Delete Account</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <Text style={{
                                        ...
                                        Selected : {Relagion ? Relagion : 'not selected'}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <Text style={{
                                        ...
                                        Selected : {RelationshipType?.length > 0 ? RelationshipType.join(', ') : 'not selected'}
                                    </Text>
                                </View>
                            </View>
                            <TouchableOpacity
                    ...
                    >
                        ...
                        }
                        {
                            ...
                            <EditUserDetailsOne
                                title={'Whats is your Couple Option?'}
                        ...
                        }
                        {
                            ...
                            <EditUserDetailsOne
                                ...
                                title={'Do you want to connect your Instagram?'}
                                setModal={setShowModal}
                                Modal={showModal}
